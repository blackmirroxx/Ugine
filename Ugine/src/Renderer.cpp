...
void ugine::TextureManager::load(const std::string &asset_path, const std::string& asset_name) {
...
void ugine::TextureManager::render(const std::string& asset_name, const AssetProps& asset_props)  const {
...
ugine::TextureManager::~TextureManager() {
